...
contract CellarBaseNftERC1155 is
    OwnableUpgradeable,
    ...
    ERC1155URIStorageUpgradeable
{
    ...
    modifier isCallerRoleOrOwner(address _operator) {
        require(
            hasRole(MINTER_ROLE, _msgSender()) ||
                isApprovedForAll(_operator, _msgSender()),
    ...
    function gift(
        ...
        emit Gift(_msgSender(),from, to, id, amount);
    }
    ...
    function giftBatch(
        ...
        emit GiftBatch(_msgSender(),from, to, ids, amounts);
    }
}
