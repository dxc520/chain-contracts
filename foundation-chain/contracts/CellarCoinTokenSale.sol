...
contract CellarCoinTokenSale is CellarCoinBaseERC20{
    ...
    event MintTokens(address indexed _from,address indexed _buyer, uint256 indexed _amount);
    event TransferTokens(address indexed _from,address indexed _recipient,uint256 indexed _amount);

    /**
     * 向系统申请铸币
     */
    function mintTokens(address _recipient,uint256 _amount) public isMinterRole {
     ...
     * proxy转移,需要approve 
     */
    function transferTokens(address _from,address _recipient,uint256 _amount) public returns(bool){
