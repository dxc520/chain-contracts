...
contract CellarNftSaleV2 is  OwnableUpgradeable, AccessControlUpgradeable,CellarBaseNftERC721,ReentrancyGuardUpgradeable{
   ...
   /*
    function setOrganiser(address organiser)public onlyOwner{
